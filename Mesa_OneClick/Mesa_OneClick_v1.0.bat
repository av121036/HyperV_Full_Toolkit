@echo off
REM ============================================================
REM  Mesa_OneClick_v1.0.bat - GUI launcher
REM
...
REM    7. Optional: restart explorer.exe to apply env vars
REM
REM  One-click usage: open as Admin, click "OneClick" button.
REM ============================================================
title Mesa OneClick v1.0 - GUI installer for software OpenGL
...
set "PS1=%~dp0Mesa_OneClick_v1.0.ps1"
if not exist "%PS1%" (
