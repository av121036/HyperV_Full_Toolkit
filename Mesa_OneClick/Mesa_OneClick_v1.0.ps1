...
$form.Text = 'Mesa OpenGL 一鍵部署工具 v1.0'
...
$grpAct.Size = New-Object System.Drawing.Size(720, 100)
$form.Controls.Add($grpAct)

$btnOneClick = New-Object System.Windows.Forms.Button
$btnOneClick.Text = '一鍵全自動 (下載 + 部署 + 設環境變數)'
$btnOneClick.Location = New-Object System.Drawing.Point(15, 25)
...
$btnDeployOnly.Location = New-Object System.Drawing.Point(410, 25)
...
$btnSetEnv.Location = New-Object System.Drawing.Point(410, 51)
...
$btnRemoveEnv.Location = New-Object System.Drawing.Point(570, 51)
...
$btnVerify.Location = New-Object System.Drawing.Point(570, 25)
...
$lblLog.Text = '日誌:'
$lblLog.Location = New-Object System.Drawing.Point(15, 505)
$lblLog.Size = New-Object System.Drawing.Size(100, 18)
$form.Controls.Add($lblLog)

$txtLog = New-Object System.Windows.Forms.TextBox
$txtLog.Location = New-Object System.Drawing.Point(15, 525)
...
$btnClose.Text = '關閉'
$btnClose.Location = New-Object System.Drawing.Point(660, 640)
...
$btnDownloadMesa.Add_Click({
    ...
    try { Do-DownloadMesa | Out-Null } finally { $btnDownloadMesa.Enabled = $true; Set-Progress 0 }
})
